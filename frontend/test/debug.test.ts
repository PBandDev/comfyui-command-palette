...
describe("debug helpers", () => {
  ...
  it("uses stable ComfyUI setting ids", () => {
    expect(SETTINGS_IDS.VERSION).toBe("ComfyUI Command Palette.Version");
    expect(SETTINGS_IDS.DEBUG_LOGGING).toBe("ComfyUI Command Palette.Debug Logging");
    expect(SETTINGS_IDS.NODE_JUMP_ZOOM).toBe("ComfyUI Command Palette.Node Jump Zoom");
    expect(SETTINGS_IDS.HIDE_API_NODES).toBe("ComfyUI Command Palette.Hide API Nodes");
  });
